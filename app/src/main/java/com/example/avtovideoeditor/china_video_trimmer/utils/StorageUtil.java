package com.example.avtovideoeditor.china_video_trimmer.utils;
...
public class StorageUtil {
  ...
  public static String getCacheDir() {
    if (TextUtils.isEmpty(sCacheDir)) {
      ...
      //  sCacheDir = file.getAbsolutePath(); // старая версия пути сохранения
        File picturesDir = Environment        // наш путь сохранения
                .getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);

        sCacheDir = picturesDir.getAbsolutePath();
