...
import com.example.avtovideoeditor.gpuvideoandroid.compose.VideoItem;
import com.example.avtovideoeditor.gpuvideoandroid.compose.VideoListAdapter;
import com.example.avtovideoeditor.gpuvideoandroid.compose.VideoLoadListener;
import com.example.avtovideoeditor.gpuvideoandroid.compose.VideoLoader;
...
public class Mp4ComposeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start_codec_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.start_play_movie).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void startCodec() {
        ...
        GPUMp4Composer = new GPUMp4Composer(videoItem.getPath(), videoPath)
                ...
                .listener(new com.daasuu.gpuv.composer.GPUMp4Composer.Listener() {
                    @Override
